...
if __name__ == "__main__":
    ...
    matrix_visibility = np.loadtxt('C:/Blender/Visibility Matrix 1000/seldom.txt')
    filename = 'C:/Blender/Visibility Matrix 1000/Coordinates.txt'
    ...
    np.savetxt('C:/Blender/Visibility Matrix 1000/coordinates seldom.txt', points, delimiter=" ")
